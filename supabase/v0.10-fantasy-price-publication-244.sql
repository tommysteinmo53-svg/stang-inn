-- Stang Inn Fantasy Hockey – v0.10
-- Update V4.6.1 atomic price publication guard from 242 to 244 roster rows.
...
begin
  ...
  if v_count <> 244 then
    raise exception 'Expected exactly 244 price rows, got %', v_count;
  end if;
