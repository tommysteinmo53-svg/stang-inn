...
export default function FantasyLeaderboard(){
 ...
 return <main className="fantasy-shell leaderboard-shell">
  ...
  <section className="leaderboard-summary">
   ...
   <article><small>Mitt lag</small><strong>{myTeam?`${myTeam.standings_position}. av ${participants}`:"—"}</strong><span>{myTeam?`${movement(myTeam)} siden forrige runde`:"Ingen plassering ennå"}</span></article>
