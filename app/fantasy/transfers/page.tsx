...
export default function TransfersPage(){
 ...
 return <main className="fantasy-shell transfer-shell">
  <header className="transfer-head"><p className="fantasy-kicker">STANG INN · FANTASY 2026/27</p><h1>Bytter</h1><p>Gjennomførte spillerbytter på det permanente 110m-laget.</p></header>
  <section className="transfer-rules"><h2>Transferregler</h2><div className="transfer-rule-grid"><article><strong>2 bytter</strong><span>per ordinær fantasy-runde; admin har 4. Ubrukte bytter spares ikke.</span></article><article><strong>4 med Bytteboost</strong><span>for vanlige brukere låses kortet når lagret transferbruk passerer 2. Admin har allerede 4.</span></article><article><strong>Ingen poengtrekk</strong><span>det er hard grense; ekstra transfers kan ikke kjøpes med poeng.</span></article><article><strong>Lagre = gjennomført</strong><span>du kan prøve fritt før lagring. Et lagret bytte refunderes ikke.</span></article></div><p>Rekke, kaptein og visekaptein kan endres uten at det teller som spillerbytte. Permanente transfers er sperret i Event Week-runder.</p></section>
