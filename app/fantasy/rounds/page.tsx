...
export default function FantasyRoundsPage(){
 ...
 const gameMap=useMemo(()=>{const m=new Map<string,Game[]>();for(const g of games){const a=m.get(g.fantasy_round_id)||[];a.push(g);m.set(g.fantasy_round_id,a)}return m},[games]);
