...
export default function PreseasonAdminPage(){
 ...
 return <main className="fantasy-shell xfp-command-center preseason-admin">
  ...
  <section className="xfp-panel">
   ...
   <div className="preseason-actions"><button className="xfp-primary" disabled={busy} onClick={()=>run("/api/admin/fantasy/preseason-import","HockeyLive-import")}>🏒 Importer HockeyLive</button><button className="xfp-primary" disabled={busy} onClick={()=>run("/api/admin/fantasy/preseason-external","Ekstern import")}>🌍 Importer eksterne kilder</button><button className="xfp-secondary" disabled={busy} onClick={runDiagnose}>🔎 Diagnostiser matching</button><button className="xfp-secondary" disabled={busy} onClick={()=>load()}>↻ Oppdater</button></div>
