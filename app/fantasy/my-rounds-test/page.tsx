...
const base={round_id:"visual-round-1",round_no:1,round_name:"Fantasy-runde 1",deadline_at:"2026-09-12T16:00:00Z",team_round_points_id:"visual-team-round-1",team_id:"visual-team-1",team_name:"Stang Inn Test XI",base_points:63,captain_bonus:8,vice_captain_bonus:0,round_points:71,calculated_at:"2026-09-13T21:00:00Z"};
const players=[
 ...
 ["d2","Testback B","D","Sparta Elite",false,true,true,1,5,1,0,5],
...
export default function MyRoundsVisualTestPage(){return <RoundPointsView rows={rows} title="Rundepoeng · visuell test" intro="Isolert testvisning med statiske data. Ingen Supabase-data leses eller endres." testMode/>}
