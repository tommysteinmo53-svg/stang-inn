...
export default function FantasyPlayPage(){
 ...
 return <main className="fantasy-shell fantasy-dashboard-shell">
  ...
  <section className="fantasy-dashboard-actions"><a className="fantasy-dashboard-card" href="/fantasy/team"><b>👥 Mitt lag</b><span>Bytt spillere, sett C ×2 og VC ×1,5 og organiser 1. og 2. rekke.</span></a><a className="fantasy-dashboard-card" href="/fantasy/my-rounds"><b>📊 Mine rundepoeng</b><span>Se nøyaktig hvilke spillere som har levert poengene dine.</span></a><a className="fantasy-dashboard-card" href="/fantasy/leaderboard"><b>🏆 Leaderboard</b><span>Se plassering, rundeseire, snitt og historikk.</span></a><a className="fantasy-dashboard-card" href="/fantasy/achievements"><b>{data.icon} {data.title}</b><span>Nåværende streak: {data.streak}. Se månedsvinnere og achievements.</span></a><a className="fantasy-dashboard-card" href="/fantasy/rounds"><b>📅 Fantasy-runder</b><span>Se kampene og deadline i hver kalenderbaserte fantasy-runde.</span></a><a className="fantasy-dashboard-card" href="/fantasy/scoring"><b>📖 Regler og scoring</b><span>Se poengsystemet, kapteinregler og hvordan spillet fungerer.</span></a></section>
