...
type Dash={teamName:string;teamId:string|null;players:number;teamCost:number;transfersUsed:number;transferLimit:number;transfersRemaining:number;roundNo:number|null;deadline:string|null;totalPoints:number;position:number|null;streak:number;title:string;icon:string};
const initial:Dash={teamName:"Mitt lag",teamId:null,players:0,teamCost:0,transfersUsed:0,transferLimit:2,transfersRemaining:2,roundNo:null,deadline:null,totalPoints:0,position:null,streak:0,title:"Rookie",icon:"🌱"};
