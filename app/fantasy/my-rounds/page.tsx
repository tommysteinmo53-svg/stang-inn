...
export default function MyFantasyRoundsPage(){
 ...
 if(busy)return <main className="fantasy-shell"><p className="fantasy-lead">Henter rundehistorikk …</p></main>;
 if(message)return <main className="fantasy-shell my-rounds-shell"><section className="team-builder-head"><div><p className="fantasy-kicker">STANG INN · FANTASY 2026/27</p><h1>Rundehistorikk</h1></div></section><p className="team-message">{message}</p></main>;
