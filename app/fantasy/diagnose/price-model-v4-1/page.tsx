...
export default function Page(){
 ...
 async function run(){setBusy(true);try{
  ...
  for(const r of roster.rows){
   ...
   const statSeason=s?S25:(historical?S24:null),statRow=s||historical;
   ...
   if(s&&old!=null&&validPos&&coef[validPos]){
    ...
    const anchor:number=Number(validPos?posMedian[validPos]:allMedian);old=anchor;rawEst=anchor;pricingClass="Provisorisk";confidence="Lav";reason=validPos?`Ny spiller · posisjonsmedian ${validPos}`:"Ny spiller · mangler posisjon, markedsmedian";
   }
