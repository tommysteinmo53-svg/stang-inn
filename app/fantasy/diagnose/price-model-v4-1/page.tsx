 ...
 async function run(){setBusy(true);try{
  ...
  for(const r of roster.rows){
   ...
   if(s&&old!=null&&validPos&&coef[validPos]){
    ...
    old=posMedian[validPos];rawEst=predictStats(coefStats[validPos],s);pricingClass="Statsmodell";confidence=Number(s.games||0)>=15?"Middels":"Lav";reason="2025/26-statistikk uten historisk fantasypris";
