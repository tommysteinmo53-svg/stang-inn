...
export default function RosterAuditPage(){
  ...
  return <main className="appShell">
    ...
    <section className="pageStack" style={{marginTop:24}}>
      <article className="heroCard"><div><p className="eyebrow">Preseason source of truth</p><h2>Produksjonsroster ↔ EliteProspects</h2><p className="muted">Read-only kontroll. Ingen spillerdata endres. Eksakt normalisert fullt navn matches først. Deretter godtas kun en unik, deterministisk navnevariant med samme første- og etternavn, EP-navnet som ordnet delmengde av fullt navn og kompatibel posisjon. Ingen fuzzy matching.</p></div><button onClick={run} disabled={busy}>{busy?"Kontrollerer …":"Kjør full roster-audit"}</button></article>
