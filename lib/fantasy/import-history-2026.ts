...
export const IMPORT_HISTORY_2026: Record<string, ImportHistory> = {
  ...
  "Santeri Arvo Sakari Hartikainen": { kind: "skater", season: "2025/26", previousTeam: "HIFK", league: "Liiga", games: 23, goals: 1, assists: 2, points: 3, source: "EliteProspects", sourceNote: "EliteProspects lists Santeri Hartikainen (C/RW); 2025/26 HIFK Liiga regular season, 23 GP, 1 G, 2 A, 3 P (0.13 P/GP). Fantasy position C." },
  ...
  "Isac Tomas Andersson": { kind: "skater", season: "2025/26", previousTeam: "Vimmerby HC", league: "HockeyAllsvenskan", games: 49, goals: 2, assists: 4, points: 6, source: "EliteProspects", sourceNote: "HockeyLive full name corresponds to EliteProspects Isac Andersson (C/LW); 2025/26 HockeyAllsvenskan regular season, 49 GP, 2 G, 4 A, 6 P" },
