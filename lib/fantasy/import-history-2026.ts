...
export const IMPORT_HISTORY_2026: Record<string, ImportHistory> = {
  ...
  "Alieu Moldal Bah": { kind: "skater", season: "2025/26", previousTeam: "Strömsbro IF", league: "HockeyEttan", games: 4, goals: 1, assists: 1, points: 2, source: "EliteProspects", sourceNote: "2025/26 senior HockeyEttan sample; also played Brynäs IF U20" },
  ...
  // Ringerike batch: keep HockeyLive's full roster names as keys so enrichment
  // works without mutating the canonical 2026/27 player pool.
