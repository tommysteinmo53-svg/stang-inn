...
Status 2026-09-15: implementert på arbeidsgren og lokalt verifisert. Produksjonsendringen er ikke gjennomført ennå. Dette addendumet overstyrer gamle forutsetninger om ti lag og 225 kamper i launch-dokumentasjonen.
...
3. Kjør hele `supabase/migrations/20260915101010_sparta_withdrawal_2026_27.sql` som én registrert migrering. Den avbryter atomisk ved utløpt frist, startet sesong, snapshots, delvis konverterte innleveringer eller tomme runder. Originale berørte rader arkiveres i `competition_adjustment_audit` med nøkkel `sparta-withdrawal-2026-27-v1`.
...
- Produksjonsmigrering, CI på PR og produksjonsdeploy: avventer, ikke registrert som PASS.
