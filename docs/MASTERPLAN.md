...
- MP-01.5 ✅ GitHub Actions build-CI inkluderer MP-12 scoring/security/test-isolation, MP-13 scoring/readiness, MP-04 transfer, Bonus Weeks, MP-07 historikk/stats og MP-10 optimizer før build.
...
**Status: ✅ eksisterende kjerne / ⬜ identitets- og Event Week-utvidelser gjenstår**
...
- MP-07.10 ⬜ **Lagnavn + eiernavn i Fantasy-tabeller:** leaderboard, rundetabeller og relevante konkurranse-/miniligaflater skal vise både Fantasy-lagnavn og bekreftet Stang Inn-profilnavn. Mobil/desktop og historisk navnepolicy skal testes eksplisitt uten å endre ranking/tie-break.
- MP-07.11 ⬜ **Produksjonskonfigurer Event Weeks:** GW15 Rik Onkel (200m) og GW38 Fattig Onkel (70m), verifisert mot kalender, deadlines, transfers, snapshots, boostere, scoring og UI.
- MP-07.12 ⬜ **Julebord – GW22:** «Alle skal med!»; begge rekker teller 100 %, ordinær C×2/VC×1,5, personlige boostere sperres, øvrige deadline-/snapshot-/lagregler beholdes.
